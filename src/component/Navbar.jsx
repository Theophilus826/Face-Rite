    ...
    source.onmessage = (event) => {
      try {
        ...
        if (payload.type === "init") {
          const initialNotifications = payload.notifications || [];

          setNotifications(initialNotifications);

          knownIdsRef.current = new Set(initialNotifications.map((n) => n._id));
...
=============================== */
  ...
  return (
    <>
      {" "}
      <header className="sticky top-0 z-50 border-b border-white/10 bg-gradient-to-r from-blue-500 via-teal-400 to-blue-500/30 backdrop-blur-md shadow-sm shadow-black/20">
        {" "}
